...
impl Dma {
    ...
    pub const fn seei(self) -> crate::common::Reg<regs::Seei, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(25usize) as _) }
    }
    ...
    pub const fn serq(self) -> crate::common::Reg<regs::Serq, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(27usize) as _) }
    }
    ...
    pub const fn ssrt(self) -> crate::common::Reg<regs::Ssrt, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(29usize) as _) }
    }
    #[doc = "Clear Error"]
    #[inline(always)]
    ...
    pub const fn cint(self) -> crate::common::Reg<regs::Cint, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(31usize) as _) }
    }
    ...
    pub const fn dchpri_x(self, n: usize) -> crate::common::Reg<regs::DchpriX, crate::common::RW> {
        assert!(n < 16usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(256usize + n * 1usize) as _) }
    }
    #[inline(always)]
    pub const fn tcd_x(self, n: usize) -> Tcd {
        assert!(n < 16usize);
        unsafe { Tcd::from_ptr(self.ptr.add(4096usize + n * 32usize) as _) }
    }
}
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub struct Tcd {
...
impl Tcd {
    ...
    #[inline(always)]
    pub const fn soff(self) -> crate::common::Reg<regs::TcdSoff, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(4usize) as _) }
    }
    ...
    #[inline(always)]
    pub const fn doff(self) -> crate::common::Reg<regs::TcdDoff, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(20usize) as _) }
    }

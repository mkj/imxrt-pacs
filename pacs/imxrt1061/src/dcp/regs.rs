...
impl defmt::Format for Capability0 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Capability0 {{ num_keys: {=u8:?}, num_channels: {=u8:?}, disable_unique_key: {=bool:?}, disable_decrypt: {=bool:?} }}" , self . num_keys () , self . num_channels () , self . disable_unique_key () , self . disable_decrypt ())
    }
}
...
impl defmt::Format for Ch0stat {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ch0stat {{ hash_mismatch: {=bool:?}, error_setup: {=bool:?}, error_packet: {=bool:?}, error_src: {=bool:?}, error_dst: {=bool:?}, error_pagefault: {=bool:?}, error_code: {:?}, tag: {=u8:?} }}" , self . hash_mismatch () , self . error_setup () , self . error_packet () , self . error_src () , self . error_dst () , self . error_pagefault () , self . error_code () , self . tag ())
    }
}
#[doc = "DCP channel 0 status register"]
#[repr(transparent)]
...
impl defmt::Format for Ch0statClr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ch0statClr {{ hash_mismatch: {=bool:?}, error_setup: {=bool:?}, error_packet: {=bool:?}, error_src: {=bool:?}, error_dst: {=bool:?}, error_pagefault: {=bool:?}, error_code: {:?}, tag: {=u8:?} }}" , self . hash_mismatch () , self . error_setup () , self . error_packet () , self . error_src () , self . error_dst () , self . error_pagefault () , self . error_code () , self . tag ())
    }
}
#[doc = "DCP channel 0 status register"]
#[repr(transparent)]
...
impl defmt::Format for Ch0statSet {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ch0statSet {{ hash_mismatch: {=bool:?}, error_setup: {=bool:?}, error_packet: {=bool:?}, error_src: {=bool:?}, error_dst: {=bool:?}, error_pagefault: {=bool:?}, error_code: {:?}, tag: {=u8:?} }}" , self . hash_mismatch () , self . error_setup () , self . error_packet () , self . error_src () , self . error_dst () , self . error_pagefault () , self . error_code () , self . tag ())
    }
}
#[doc = "DCP channel 0 status register"]
#[repr(transparent)]
...
impl defmt::Format for Ch0statTog {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ch0statTog {{ hash_mismatch: {=bool:?}, error_setup: {=bool:?}, error_packet: {=bool:?}, error_src: {=bool:?}, error_dst: {=bool:?}, error_pagefault: {=bool:?}, error_code: {:?}, tag: {=u8:?} }}" , self . hash_mismatch () , self . error_setup () , self . error_packet () , self . error_src () , self . error_dst () , self . error_pagefault () , self . error_code () , self . tag ())
    }
}
...
impl defmt::Format for Ch1stat {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ch1stat {{ hash_mismatch: {=bool:?}, error_setup: {=bool:?}, error_packet: {=bool:?}, error_src: {=bool:?}, error_dst: {=bool:?}, error_pagefault: {=bool:?}, error_code: {:?}, tag: {=u8:?} }}" , self . hash_mismatch () , self . error_setup () , self . error_packet () , self . error_src () , self . error_dst () , self . error_pagefault () , self . error_code () , self . tag ())
    }
}
#[doc = "DCP channel 1 status register"]
#[repr(transparent)]
...
impl defmt::Format for Ch1statClr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ch1statClr {{ hash_mismatch: {=bool:?}, error_setup: {=bool:?}, error_packet: {=bool:?}, error_src: {=bool:?}, error_dst: {=bool:?}, error_pagefault: {=bool:?}, error_code: {:?}, tag: {=u8:?} }}" , self . hash_mismatch () , self . error_setup () , self . error_packet () , self . error_src () , self . error_dst () , self . error_pagefault () , self . error_code () , self . tag ())
    }
}
#[doc = "DCP channel 1 status register"]
#[repr(transparent)]
...
impl defmt::Format for Ch1statSet {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ch1statSet {{ hash_mismatch: {=bool:?}, error_setup: {=bool:?}, error_packet: {=bool:?}, error_src: {=bool:?}, error_dst: {=bool:?}, error_pagefault: {=bool:?}, error_code: {:?}, tag: {=u8:?} }}" , self . hash_mismatch () , self . error_setup () , self . error_packet () , self . error_src () , self . error_dst () , self . error_pagefault () , self . error_code () , self . tag ())
    }
}
#[doc = "DCP channel 1 status register"]
#[repr(transparent)]
...
impl defmt::Format for Ch1statTog {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ch1statTog {{ hash_mismatch: {=bool:?}, error_setup: {=bool:?}, error_packet: {=bool:?}, error_src: {=bool:?}, error_dst: {=bool:?}, error_pagefault: {=bool:?}, error_code: {:?}, tag: {=u8:?} }}" , self . hash_mismatch () , self . error_setup () , self . error_packet () , self . error_src () , self . error_dst () , self . error_pagefault () , self . error_code () , self . tag ())
    }
}
...
impl defmt::Format for Ch2stat {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ch2stat {{ hash_mismatch: {=bool:?}, error_setup: {=bool:?}, error_packet: {=bool:?}, error_src: {=bool:?}, error_dst: {=bool:?}, error_pagefault: {=bool:?}, error_code: {:?}, tag: {=u8:?} }}" , self . hash_mismatch () , self . error_setup () , self . error_packet () , self . error_src () , self . error_dst () , self . error_pagefault () , self . error_code () , self . tag ())
    }
}
#[doc = "DCP channel 2 status register"]
#[repr(transparent)]
...
impl defmt::Format for Ch2statClr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ch2statClr {{ hash_mismatch: {=bool:?}, error_setup: {=bool:?}, error_packet: {=bool:?}, error_src: {=bool:?}, error_dst: {=bool:?}, error_pagefault: {=bool:?}, error_code: {:?}, tag: {=u8:?} }}" , self . hash_mismatch () , self . error_setup () , self . error_packet () , self . error_src () , self . error_dst () , self . error_pagefault () , self . error_code () , self . tag ())
    }
}
#[doc = "DCP channel 2 status register"]
#[repr(transparent)]
...
impl defmt::Format for Ch2statSet {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ch2statSet {{ hash_mismatch: {=bool:?}, error_setup: {=bool:?}, error_packet: {=bool:?}, error_src: {=bool:?}, error_dst: {=bool:?}, error_pagefault: {=bool:?}, error_code: {:?}, tag: {=u8:?} }}" , self . hash_mismatch () , self . error_setup () , self . error_packet () , self . error_src () , self . error_dst () , self . error_pagefault () , self . error_code () , self . tag ())
    }
}
#[doc = "DCP channel 2 status register"]
#[repr(transparent)]
...
impl defmt::Format for Ch2statTog {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ch2statTog {{ hash_mismatch: {=bool:?}, error_setup: {=bool:?}, error_packet: {=bool:?}, error_src: {=bool:?}, error_dst: {=bool:?}, error_pagefault: {=bool:?}, error_code: {:?}, tag: {=u8:?} }}" , self . hash_mismatch () , self . error_setup () , self . error_packet () , self . error_src () , self . error_dst () , self . error_pagefault () , self . error_code () , self . tag ())
    }
}
...
impl defmt::Format for Ch3stat {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ch3stat {{ hash_mismatch: {=bool:?}, error_setup: {=bool:?}, error_packet: {=bool:?}, error_src: {=bool:?}, error_dst: {=bool:?}, error_pagefault: {=bool:?}, error_code: {:?}, tag: {=u8:?} }}" , self . hash_mismatch () , self . error_setup () , self . error_packet () , self . error_src () , self . error_dst () , self . error_pagefault () , self . error_code () , self . tag ())
    }
}
#[doc = "DCP channel 3 status register"]
#[repr(transparent)]
...
impl defmt::Format for Ch3statClr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ch3statClr {{ hash_mismatch: {=bool:?}, error_setup: {=bool:?}, error_packet: {=bool:?}, error_src: {=bool:?}, error_dst: {=bool:?}, error_pagefault: {=bool:?}, error_code: {:?}, tag: {=u8:?} }}" , self . hash_mismatch () , self . error_setup () , self . error_packet () , self . error_src () , self . error_dst () , self . error_pagefault () , self . error_code () , self . tag ())
    }
}
#[doc = "DCP channel 3 status register"]
#[repr(transparent)]
...
impl defmt::Format for Ch3statSet {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ch3statSet {{ hash_mismatch: {=bool:?}, error_setup: {=bool:?}, error_packet: {=bool:?}, error_src: {=bool:?}, error_dst: {=bool:?}, error_pagefault: {=bool:?}, error_code: {:?}, tag: {=u8:?} }}" , self . hash_mismatch () , self . error_setup () , self . error_packet () , self . error_src () , self . error_dst () , self . error_pagefault () , self . error_code () , self . tag ())
    }
}
#[doc = "DCP channel 3 status register"]
#[repr(transparent)]
...
impl defmt::Format for Ch3statTog {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ch3statTog {{ hash_mismatch: {=bool:?}, error_setup: {=bool:?}, error_packet: {=bool:?}, error_src: {=bool:?}, error_dst: {=bool:?}, error_pagefault: {=bool:?}, error_code: {:?}, tag: {=u8:?} }}" , self . hash_mismatch () , self . error_setup () , self . error_packet () , self . error_src () , self . error_dst () , self . error_pagefault () , self . error_code () , self . tag ())
    }
}
...
impl defmt::Format for Channelctrl {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Channelctrl {{ enable_channel: {:?}, high_priority_channel: {:?}, ch0_irq_merged: {=bool:?} }}" , self . enable_channel () , self . high_priority_channel () , self . ch0_irq_merged ())
    }
}
#[doc = "DCP channel control register"]
#[repr(transparent)]
...
impl defmt::Format for ChannelctrlClr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "ChannelctrlClr {{ enable_channel: {:?}, high_priority_channel: {:?}, ch0_irq_merged: {=bool:?} }}" , self . enable_channel () , self . high_priority_channel () , self . ch0_irq_merged ())
    }
}
#[doc = "DCP channel control register"]
#[repr(transparent)]
...
impl defmt::Format for ChannelctrlSet {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "ChannelctrlSet {{ enable_channel: {:?}, high_priority_channel: {:?}, ch0_irq_merged: {=bool:?} }}" , self . enable_channel () , self . high_priority_channel () , self . ch0_irq_merged ())
    }
}
#[doc = "DCP channel control register"]
#[repr(transparent)]
...
impl defmt::Format for ChannelctrlTog {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "ChannelctrlTog {{ enable_channel: {:?}, high_priority_channel: {:?}, ch0_irq_merged: {=bool:?} }}" , self . enable_channel () , self . high_priority_channel () , self . ch0_irq_merged ())
    }
}
...
impl defmt::Format for Ctrl {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ctrl {{ channel_interrupt_enable: {:?}, enable_context_switching: {=bool:?}, enable_context_caching: {=bool:?}, gather_residual_writes: {=bool:?}, present_sha: {=bool:?}, present_crypto: {=bool:?}, clkgate: {=bool:?}, sftrst: {=bool:?} }}" , self . channel_interrupt_enable () , self . enable_context_switching () , self . enable_context_caching () , self . gather_residual_writes () , self . present_sha () , self . present_crypto () , self . clkgate () , self . sftrst ())
    }
}
#[doc = "DCP control register 0"]
#[repr(transparent)]
...
impl defmt::Format for CtrlClr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "CtrlClr {{ channel_interrupt_enable: {:?}, enable_context_switching: {=bool:?}, enable_context_caching: {=bool:?}, gather_residual_writes: {=bool:?}, present_sha: {=bool:?}, present_crypto: {=bool:?}, clkgate: {=bool:?}, sftrst: {=bool:?} }}" , self . channel_interrupt_enable () , self . enable_context_switching () , self . enable_context_caching () , self . gather_residual_writes () , self . present_sha () , self . present_crypto () , self . clkgate () , self . sftrst ())
    }
}
#[doc = "DCP control register 0"]
#[repr(transparent)]
...
impl defmt::Format for CtrlSet {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "CtrlSet {{ channel_interrupt_enable: {:?}, enable_context_switching: {=bool:?}, enable_context_caching: {=bool:?}, gather_residual_writes: {=bool:?}, present_sha: {=bool:?}, present_crypto: {=bool:?}, clkgate: {=bool:?}, sftrst: {=bool:?} }}" , self . channel_interrupt_enable () , self . enable_context_switching () , self . enable_context_caching () , self . gather_residual_writes () , self . present_sha () , self . present_crypto () , self . clkgate () , self . sftrst ())
    }
}
#[doc = "DCP control register 0"]
#[repr(transparent)]
...
impl defmt::Format for CtrlTog {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "CtrlTog {{ channel_interrupt_enable: {:?}, enable_context_switching: {=bool:?}, enable_context_caching: {=bool:?}, gather_residual_writes: {=bool:?}, present_sha: {=bool:?}, present_crypto: {=bool:?}, clkgate: {=bool:?}, sftrst: {=bool:?} }}" , self . channel_interrupt_enable () , self . enable_context_switching () , self . enable_context_caching () , self . gather_residual_writes () , self . present_sha () , self . present_crypto () , self . clkgate () , self . sftrst ())
    }
}
...
impl defmt::Format for Packet1 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Packet1 {{ interrupt: {=bool:?}, decr_semaphore: {=bool:?}, chain: {=bool:?}, chain_contiguous: {=bool:?}, enable_memcopy: {=bool:?}, enable_cipher: {=bool:?}, enable_hash: {=bool:?}, enable_blit: {=bool:?}, cipher_encrypt: {=bool:?}, cipher_init: {=bool:?}, otp_key: {=bool:?}, payload_key: {=bool:?}, hash_init: {=bool:?}, hash_term: {=bool:?}, check_hash: {=bool:?}, hash_output: {=bool:?}, constant_fill: {=bool:?}, test_sema_irq: {=bool:?}, key_byteswap: {=bool:?}, key_wordswap: {=bool:?}, input_byteswap: {=bool:?}, input_wordswap: {=bool:?}, output_byteswap: {=bool:?}, output_wordswap: {=bool:?}, tag: {=u8:?} }}" , self . interrupt () , self . decr_semaphore () , self . chain () , self . chain_contiguous () , self . enable_memcopy () , self . enable_cipher () , self . enable_hash () , self . enable_blit () , self . cipher_encrypt () , self . cipher_init () , self . otp_key () , self . payload_key () , self . hash_init () , self . hash_term () , self . check_hash () , self . hash_output () , self . constant_fill () , self . test_sema_irq () , self . key_byteswap () , self . key_wordswap () , self . input_byteswap () , self . input_wordswap () , self . output_byteswap () , self . output_wordswap () , self . tag ())
    }
}
...
impl defmt::Format for Packet2 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Packet2 {{ cipher_select: {:?}, cipher_mode: {:?}, key_select: {:?}, hash_select: {:?}, cipher_cfg: {=u8:?} }}" , self . cipher_select () , self . cipher_mode () , self . key_select () , self . hash_select () , self . cipher_cfg ())
    }
}
...
impl defmt::Format for Stat {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Stat {{ irq: {=u8:?}, ready_channels: {:?}, cur_channel: {:?}, otp_key_ready: {=bool:?} }}" , self . irq () , self . ready_channels () , self . cur_channel () , self . otp_key_ready ())
    }
}
#[doc = "DCP status register"]
#[repr(transparent)]
...
impl defmt::Format for StatClr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "StatClr {{ irq: {=u8:?}, ready_channels: {:?}, cur_channel: {:?}, otp_key_ready: {=bool:?} }}" , self . irq () , self . ready_channels () , self . cur_channel () , self . otp_key_ready ())
    }
}
#[doc = "DCP status register"]
#[repr(transparent)]
...
impl defmt::Format for StatSet {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "StatSet {{ irq: {=u8:?}, ready_channels: {:?}, cur_channel: {:?}, otp_key_ready: {=bool:?} }}" , self . irq () , self . ready_channels () , self . cur_channel () , self . otp_key_ready ())
    }
}
#[doc = "DCP status register"]
#[repr(transparent)]
...
impl defmt::Format for StatTog {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "StatTog {{ irq: {=u8:?}, ready_channels: {:?}, cur_channel: {:?}, otp_key_ready: {=bool:?} }}" , self . irq () , self . ready_channels () , self . cur_channel () , self . otp_key_ready ())
    }
}

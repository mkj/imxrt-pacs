...
impl defmt::Format for Rcr4 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Rcr4 {{ fsd: {=bool:?}, fsp: {=bool:?}, ondem: {=bool:?}, fse: {=bool:?}, mf: {=bool:?}, sywd: {=u8:?}, frsz: {=u8:?}, fpack: {:?}, fcomb: {:?}, fcont: {=bool:?} }}" , self . fsd () , self . fsp () , self . ondem () , self . fse () , self . mf () , self . sywd () , self . frsz () , self . fpack () , self . fcomb () , self . fcont ())
    }
}
...
impl defmt::Format for Tcr4 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Tcr4 {{ fsd: {=bool:?}, fsp: {=bool:?}, ondem: {=bool:?}, fse: {=bool:?}, mf: {=bool:?}, chmod: {=bool:?}, sywd: {=u8:?}, frsz: {=u8:?}, fpack: {:?}, fcomb: {:?}, fcont: {=bool:?} }}" , self . fsd () , self . fsp () , self . ondem () , self . fse () , self . mf () , self . chmod () , self . sywd () , self . frsz () , self . fpack () , self . fcomb () , self . fcont ())
    }
}

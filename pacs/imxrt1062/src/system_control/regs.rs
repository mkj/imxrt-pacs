...
impl core::fmt::Debug for Actlr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Actlr")
            ...
            .field("disbtacread", &self.disbtacread())
            .field("disbtacalloc", &self.disbtacalloc())
            .field("discritaxirur", &self.discritaxirur())
            .field("disdi", &self.disdi())
            .field("disissch1", &self.disissch1())
            .field("disdynadd", &self.disdynadd())
            .field("discritaxiruw", &self.discritaxiruw())
            .field("disfpuissopt", &self.disfpuissopt())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Actlr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Actlr {{ disfold: {=bool:?}, fpexcodis: {=bool:?}, disramode: {=bool:?}, disitmatbflush: {=bool:?}, disbtacread: {=bool:?}, disbtacalloc: {=bool:?}, discritaxirur: {=bool:?}, disdi: {:?}, disissch1: {:?}, disdynadd: {=bool:?}, discritaxiruw: {=bool:?}, disfpuissopt: {=bool:?} }}" , self . disfold () , self . fpexcodis () , self . disramode () , self . disitmatbflush () , self . disbtacread () , self . disbtacalloc () , self . discritaxirur () , self . disdi () , self . disissch1 () , self . disdynadd () , self . discritaxiruw () , self . disfpuissopt ())
    }
}
...
impl defmt::Format for Aircr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Aircr {{ vectreset: {=bool:?}, vectclractive: {=bool:?}, sysresetreq: {=bool:?}, prigroup: {=u8:?}, endianness: {=bool:?}, vectkey: {=u16:?} }}" , self . vectreset () , self . vectclractive () , self . sysresetreq () , self . prigroup () , self . endianness () , self . vectkey ())
    }
}
...
impl core::fmt::Debug for Ccr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Ccr")
            .field("nonbasethrdena", &self.nonbasethrdena())
...
impl defmt::Format for Ccr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ccr {{ nonbasethrdena: {=bool:?}, usersetmpend: {=bool:?}, unalign_trp: {=bool:?}, div_0_trp: {=bool:?}, bfhfnmign: {=bool:?}, stkalign: {=bool:?}, dc: {=bool:?}, ic: {=bool:?}, bp: {=bool:?} }}" , self . nonbasethrdena () , self . usersetmpend () , self . unalign_trp () , self . div_0_trp () , self . bfhfnmign () , self . stkalign () , self . dc () , self . ic () , self . bp ())
    }
}
...
#[cfg(feature = "defmt")]
impl defmt::Format for Ccsidr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ccsidr {{ linesize: {:?}, associativity: {=u16:?}, numsets: {=u16:?}, wa: {=bool:?}, ra: {=bool:?}, wb: {=bool:?}, wt: {=bool:?} }}" , self . linesize () , self . associativity () , self . numsets () , self . wa () , self . ra () , self . wb () , self . wt ())
    }
}
...
impl defmt::Format for Cfsr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Cfsr {{ iaccviol: {=bool:?}, daccviol: {=bool:?}, munstkerr: {=bool:?}, mstkerr: {=bool:?}, mlsperr: {=bool:?}, mmarvalid: {=bool:?}, ibuserr: {=bool:?}, preciserr: {=bool:?}, impreciserr: {=bool:?}, unstkerr: {=bool:?}, stkerr: {=bool:?}, lsperr: {=bool:?}, bfarvalid: {=bool:?}, undefinstr: {=bool:?}, invstate: {=bool:?}, invpc: {=bool:?}, nocp: {=bool:?}, unaligned: {=bool:?}, divbyzero: {=bool:?} }}" , self . iaccviol () , self . daccviol () , self . munstkerr () , self . mstkerr () , self . mlsperr () , self . mmarvalid () , self . ibuserr () , self . preciserr () , self . impreciserr () , self . unstkerr () , self . stkerr () , self . lsperr () , self . bfarvalid () , self . undefinstr () , self . invstate () , self . invpc () , self . nocp () , self . unaligned () , self . divbyzero ())
    }
}
...
#[cfg(feature = "defmt")]
impl defmt::Format for Clidr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Clidr {{ cl1: {:?}, cl2: {:?}, cl3: {:?}, cl4: {:?}, cl5: {:?}, cl6: {:?}, cl7: {:?}, louis: {:?}, loc: {:?}, lou: {:?} }}" , self . cl1 () , self . cl2 () , self . cl3 () , self . cl4 () , self . cl5 () , self . cl6 () , self . cl7 () , self . louis () , self . loc () , self . lou ())
    }
}
...
impl core::fmt::Debug for Cm7abfsr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Cm7abfsr")
...
#[cfg(feature = "defmt")]
impl defmt::Format for Cm7abfsr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Cm7abfsr {{ itcm: {=bool:?}, dtcm: {=bool:?}, ahbp: {=bool:?}, axim: {=bool:?}, eppb: {=bool:?}, aximtype: {:?} }}" , self . itcm () , self . dtcm () , self . ahbp () , self . axim () , self . eppb () , self . aximtype ())
    }
}
...
impl core::fmt::Debug for Cm7ahbpcr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Cm7ahbpcr")
            .field("en", &self.en())
            .field("sz", &self.sz())
            .finish()
    }
...
#[cfg(feature = "defmt")]
impl defmt::Format for Cm7ahbpcr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Cm7ahbpcr {{ en: {=bool:?}, sz: {:?} }}",
            self.en(),
            self.sz()
        )
    }
...
impl core::fmt::Debug for Cm7ahbscr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Cm7ahbscr")
            .field("ctl", &self.ctl())
...
#[cfg(feature = "defmt")]
impl defmt::Format for Cm7ahbscr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Cm7ahbscr {{ ctl: {:?}, tpri: {=u16:?}, initcount: {=u8:?} }}",
            self.ctl(),
            self.tpri(),
            self.initcount()
        )
...
impl core::fmt::Debug for Cm7cacr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Cm7cacr")
            .field("siwt", &self.siwt())
            .field("eccdis", &self.eccdis())
            .field("forcewt", &self.forcewt())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Cm7cacr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Cm7cacr {{ siwt: {=bool:?}, eccdis: {=bool:?}, forcewt: {=bool:?} }}",
            self.siwt(),
            self.eccdis(),
            self.forcewt()
        )
...
impl core::fmt::Debug for Cm7dtcmcr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Cm7dtcmcr")
            .field("en", &self.en())
            .field("rmw", &self.rmw())
...
#[cfg(feature = "defmt")]
impl defmt::Format for Cm7dtcmcr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Cm7dtcmcr {{ en: {=bool:?}, rmw: {=bool:?}, reten: {=bool:?}, sz: {:?} }}",
            self.en(),
            self.rmw(),
            self.reten(),
            self.sz()
...
impl core::fmt::Debug for Cm7itcmcr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Cm7itcmcr")
            .field("en", &self.en())
            .field("rmw", &self.rmw())
            .field("reten", &self.reten())
            .field("sz", &self.sz())
...
#[cfg(feature = "defmt")]
impl defmt::Format for Cm7itcmcr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Cm7itcmcr {{ en: {=bool:?}, rmw: {=bool:?}, reten: {=bool:?}, sz: {:?} }}",
            self.en(),
            self.rmw(),
            self.reten(),
            self.sz()
...
impl defmt::Format for Cpacr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Cpacr {{ cp0: {:?}, cp1: {:?}, cp2: {:?}, cp3: {:?}, cp4: {:?}, cp5: {:?}, cp6: {:?}, cp7: {:?}, cp10: {:?}, cp11: {:?} }}" , self . cp0 () , self . cp1 () , self . cp2 () , self . cp3 () , self . cp4 () , self . cp5 () , self . cp6 () , self . cp7 () , self . cp10 () , self . cp11 ())
    }
}
...
impl defmt::Format for Cpuid {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Cpuid {{ revision: {=u8:?}, partno: {=u16:?}, architecture: {=u8:?}, variant: {=u8:?}, implementer: {=u8:?} }}" , self . revision () , self . partno () , self . architecture () , self . variant () , self . implementer ())
    }
}
...
impl core::fmt::Debug for Csselr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Csselr")
            .field("ind", &self.ind())
...
#[cfg(feature = "defmt")]
impl defmt::Format for Csselr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Csselr {{ ind: {=bool:?}, level: {:?} }}",
            self.ind(),
            self.level()
        )
    }
...
impl core::fmt::Debug for Ctr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Ctr")
            .field("iminline", &self.iminline())
            .field("dminline", &self.dminline())
            .field("erg", &self.erg())
            .field("cwg", &self.cwg())
...
impl defmt::Format for Ctr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Ctr {{ iminline: {=u8:?}, dminline: {=u8:?}, erg: {=u8:?}, cwg: {=u8:?}, format: {:?} }}" , self . iminline () , self . dminline () , self . erg () , self . cwg () , self . format ())
    }
}
...
impl defmt::Format for Dfsr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Dfsr {{ halted: {=bool:?}, bkpt: {=bool:?}, dwttrap: {=bool:?}, vcatch: {=bool:?}, external: {=bool:?} }}" , self . halted () , self . bkpt () , self . dwttrap () , self . vcatch () , self . external ())
    }
}
...
impl defmt::Format for Hfsr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Hfsr {{ vecttbl: {=bool:?}, forced: {=bool:?}, debugevt: {=bool:?} }}",
            self.vecttbl(),
            self.forced(),
            self.debugevt()
        )
...
impl defmt::Format for Icsr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Icsr {{ vectactive: {=u16:?}, rettobase: {=bool:?}, vectpending: {=u16:?}, isrpending: {=bool:?}, pendstclr: {=bool:?}, pendstset: {=bool:?}, pendsvclr: {=bool:?}, pendsvset: {=bool:?}, nmipendset: {=bool:?} }}" , self . vectactive () , self . rettobase () , self . vectpending () , self . isrpending () , self . pendstclr () , self . pendstset () , self . pendsvclr () , self . pendsvset () , self . nmipendset ())
    }
}
...
impl core::fmt::Debug for IdAfr0 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IdAfr0")
            .field("implementation_defined0", &self.implementation_defined0())
            .field("implementation_defined1", &self.implementation_defined1())
            .field("implementation_defined2", &self.implementation_defined2())
            .field("implementation_defined3", &self.implementation_defined3())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for IdAfr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "IdAfr0 {{ implementation_defined0: {=u8:?}, implementation_defined1: {=u8:?}, implementation_defined2: {=u8:?}, implementation_defined3: {=u8:?} }}" , self . implementation_defined0 () , self . implementation_defined1 () , self . implementation_defined2 () , self . implementation_defined3 ())
    }
}
...
impl core::fmt::Debug for IdDfr0 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IdDfr0")
            .field("debugmodel", &self.debugmodel())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for IdDfr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "IdDfr0 {{ debugmodel: {:?} }}", self.debugmodel())
    }
}
...
impl core::fmt::Debug for IdIsar0 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IdIsar0")
            .field("bitcount_instrs", &self.bitcount_instrs())
            .field("bitfield_instrs", &self.bitfield_instrs())
            .field("cmpbranch_instrs", &self.cmpbranch_instrs())
            .field("coproc_instrs", &self.coproc_instrs())
            .field("debug_instrs", &self.debug_instrs())
            .field("divide_instrs", &self.divide_instrs())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for IdIsar0 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "IdIsar0 {{ bitcount_instrs: {:?}, bitfield_instrs: {:?}, cmpbranch_instrs: {:?}, coproc_instrs: {:?}, debug_instrs: {:?}, divide_instrs: {:?} }}" , self . bitcount_instrs () , self . bitfield_instrs () , self . cmpbranch_instrs () , self . coproc_instrs () , self . debug_instrs () , self . divide_instrs ())
    }
}
...
impl core::fmt::Debug for IdIsar1 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IdIsar1")
            .field("extend_instrs", &self.extend_instrs())
            .field("ifthen_instrs", &self.ifthen_instrs())
            .field("immediate_instrs", &self.immediate_instrs())
            .field("interwork_instrs", &self.interwork_instrs())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for IdIsar1 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "IdIsar1 {{ extend_instrs: {:?}, ifthen_instrs: {:?}, immediate_instrs: {:?}, interwork_instrs: {:?} }}" , self . extend_instrs () , self . ifthen_instrs () , self . immediate_instrs () , self . interwork_instrs ())
    }
}
...
impl core::fmt::Debug for IdIsar2 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IdIsar2")
            .field("loadstore_instrs", &self.loadstore_instrs())
            .field("memhint_instrs", &self.memhint_instrs())
            .field("multiaccessint_instrs", &self.multiaccessint_instrs())
            .field("mult_instrs", &self.mult_instrs())
            .field("mults_instrs", &self.mults_instrs())
            .field("multu_instrs", &self.multu_instrs())
            .field("reversal_instrs", &self.reversal_instrs())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for IdIsar2 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "IdIsar2 {{ loadstore_instrs: {:?}, memhint_instrs: {:?}, multiaccessint_instrs: {:?}, mult_instrs: {:?}, mults_instrs: {:?}, multu_instrs: {:?}, reversal_instrs: {:?} }}" , self . loadstore_instrs () , self . memhint_instrs () , self . multiaccessint_instrs () , self . mult_instrs () , self . mults_instrs () , self . multu_instrs () , self . reversal_instrs ())
    }
}
...
impl core::fmt::Debug for IdIsar3 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IdIsar3")
            .field("saturate_instrs", &self.saturate_instrs())
            .field("simd_instrs", &self.simd_instrs())
            .field("svc_instrs", &self.svc_instrs())
            .field("synchprim_instrs", &self.synchprim_instrs())
            .field("tabbranch_instrs", &self.tabbranch_instrs())
            .field("thumbcopy_instrs", &self.thumbcopy_instrs())
            .field("truenop_instrs", &self.truenop_instrs())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for IdIsar3 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "IdIsar3 {{ saturate_instrs: {:?}, simd_instrs: {:?}, svc_instrs: {:?}, synchprim_instrs: {=u8:?}, tabbranch_instrs: {:?}, thumbcopy_instrs: {:?}, truenop_instrs: {:?} }}" , self . saturate_instrs () , self . simd_instrs () , self . svc_instrs () , self . synchprim_instrs () , self . tabbranch_instrs () , self . thumbcopy_instrs () , self . truenop_instrs ())
    }
}
...
impl core::fmt::Debug for IdIsar4 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IdIsar4")
            .field("unpriv_instrs", &self.unpriv_instrs())
            .field("withshifts_instrs", &self.withshifts_instrs())
            .field("writeback_instrs", &self.writeback_instrs())
            .field("barrier_instrs", &self.barrier_instrs())
            .field("synchprim_instrs_frac", &self.synchprim_instrs_frac())
            .field("psr_m_instrs", &self.psr_m_instrs())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for IdIsar4 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "IdIsar4 {{ unpriv_instrs: {:?}, withshifts_instrs: {:?}, writeback_instrs: {:?}, barrier_instrs: {:?}, synchprim_instrs_frac: {=u8:?}, psr_m_instrs: {:?} }}" , self . unpriv_instrs () , self . withshifts_instrs () , self . writeback_instrs () , self . barrier_instrs () , self . synchprim_instrs_frac () , self . psr_m_instrs ())
    }
}
...
impl core::fmt::Debug for IdMmfr0 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IdMmfr0")
            .field("pmsasupport", &self.pmsasupport())
            .field("outermost_shareability", &self.outermost_shareability())
            .field("shareability_levels", &self.shareability_levels())
            .field("tcm_support", &self.tcm_support())
            .field("auxiliary_registers", &self.auxiliary_registers())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for IdMmfr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "IdMmfr0 {{ pmsasupport: {:?}, outermost_shareability: {:?}, shareability_levels: {:?}, tcm_support: {:?}, auxiliary_registers: {:?} }}" , self . pmsasupport () , self . outermost_shareability () , self . shareability_levels () , self . tcm_support () , self . auxiliary_registers ())
    }
}
...
impl core::fmt::Debug for IdMmfr2 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IdMmfr2")
            .field("wfi_stall", &self.wfi_stall())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for IdMmfr2 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "IdMmfr2 {{ wfi_stall: {:?} }}", self.wfi_stall())
    }
}
...
impl core::fmt::Debug for IdPfr0 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IdPfr0")
            .field("state0", &self.state0())
            .field("state1", &self.state1())
            .field("state2", &self.state2())
            .field("state3", &self.state3())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for IdPfr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "IdPfr0 {{ state0: {:?}, state1: {:?}, state2: {=u8:?}, state3: {=u8:?} }}",
            self.state0(),
            self.state1(),
            self.state2(),
            self.state3()
...
impl core::fmt::Debug for IdPfr1 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IdPfr1")
            .field("progmodel", &self.progmodel())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for IdPfr1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "IdPfr1 {{ progmodel: {:?} }}", self.progmodel())
    }
}
...
impl defmt::Format for Scr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Scr {{ sleeponexit: {=bool:?}, sleepdeep: {=bool:?}, sevonpend: {=bool:?} }}",
            self.sleeponexit(),
            self.sleepdeep(),
            self.sevonpend()
        )
...
impl defmt::Format for Shcsr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Shcsr {{ memfaultact: {=bool:?}, busfaultact: {=bool:?}, usgfaultact: {=bool:?}, svcallact: {=bool:?}, monitoract: {=bool:?}, pendsvact: {=bool:?}, systickact: {=bool:?}, usgfaultpended: {=bool:?}, memfaultpended: {=bool:?}, busfaultpended: {=bool:?}, svcallpended: {=bool:?}, memfaultena: {=bool:?}, busfaultena: {=bool:?}, usgfaultena: {=bool:?} }}" , self . memfaultact () , self . busfaultact () , self . usgfaultact () , self . svcallact () , self . monitoract () , self . pendsvact () , self . systickact () , self . usgfaultpended () , self . memfaultpended () , self . busfaultpended () , self . svcallpended () , self . memfaultena () , self . busfaultena () , self . usgfaultena ())
    }
}
...
impl defmt::Format for Shpr1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Shpr1 {{ pri_4: {=u8:?}, pri_5: {=u8:?}, pri_6: {=u8:?} }}",
            self.pri_4(),
            self.pri_5(),
            self.pri_6()
        )
...
impl defmt::Format for Shpr2 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Shpr2 {{ pri_11: {=u8:?} }}", self.pri_11())
    }
}
...
impl defmt::Format for Vtor {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Vtor {{ tbloff: {=u32:?} }}", self.tbloff())
    }
}

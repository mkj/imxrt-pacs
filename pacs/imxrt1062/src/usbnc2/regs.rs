...
impl defmt::Format for UsbOtg2phyCtrl0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "UsbOtg2phyCtrl0 {{ utmi_clk_vld: {=bool:?} }}",
            self.utmi_clk_vld()
        )
    }
}
